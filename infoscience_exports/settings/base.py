...
RANGE_DISPLAY = get_env_variable('RANGE_DISPLAY', 500)
...
CSRF_TRUSTED_ORIGINS = ['https://*.epfl.ch','https://127.0.0.1', get_env_variable('SITE_URL')]
...
CACHES = {
    'default': {
        ...
        'TIMEOUT': get_env_variable('CACHE_TIMEOUT', 43200),  # 12h
        'OPTIONS': {
