# Generated by Django 2.0.2 on 2018-02-20 14:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bullets_type', models.CharField(choices=[('', ''), ('CHARACTER_STAR', '*'), ('CHARACTER_MINUS', '-'), ('NUMBER_ASC', '1, 2, 3, ...'), ('NUMBER_DESC', '..., 3, 2, 1')], max_length=255, null=True)),
