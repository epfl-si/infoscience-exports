...
export_patterns = ([
    ...
    url(r'^(?P<pk>\d+)/$', views.ExportView.as_view(template_name="exports/export.html"), name='export-view'),
    url(r'^(?P<pk>\d+)/old/$', views.ExportView.as_view(template_name="exports_2010/export.html"), name='export-2010-view'),
